...
class tvDescription extends React.Component{
    render()
    {
        const {id}=this.props.match.params
        const {url}=this.props.match
        const {tv,handleCart}=this.context
        console.log(id)
        const item=tv.find(item=>item.id===Number(id))
...
tvDescription.contextType=AppContext
